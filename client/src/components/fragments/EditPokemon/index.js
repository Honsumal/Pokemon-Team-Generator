        ...
        try {
            const {data} = await editPokemon({
                variables: {
                    ...
                    item: ch(i) || "(none)",
                    nature: na,
                    hpEv: parseInt(hpEV) || 0,
                    atkEv: parseInt(atkEV) || 0,
                    defEv: parseInt(defEV) || 0,
                    spaEv: parseInt(spaEV) || 0,
                    spdefEv: parseInt(sdfEV) || 0,
                    spdEv: parseInt(spdEV) || 0,
                    hpIv: parseInt(hpIV) || 0,
                    atkIv: parseInt(atkIV) || 0,
                    defIv: parseInt(defIV) || 0,
                    spaIv: parseInt(spaIV) || 0,
                    spdefIv: parseInt(sdfIV) || 0,
                    spdIv: parseInt(spdIV) || 0,
                    tera: te
                }
            });
        } catch (err) {
